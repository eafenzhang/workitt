...
const MENU_ITEMS: MenuItem[] = [
  ...
  { action: 'group', label: '分组选中', icon: Group, requireGroup: true },
  { action: 'boolean-union', label: '布尔并集', icon: SquaresUnite, requireBoolean: true },
  {
  ...
  { action: 'detach-component', label: '分离组件', icon: Unlink, requireReusable: true },
  { action: 'detach-component', label: '分离实例', icon: Unlink, requireInstance: true },
  { action: 'lock', label: '切换锁定', icon: Lock },
  { action: 'hide', label: '切换可见性', icon: EyeOff },
];
