  ...
  return (
    <div className="space-y-1.5">
      ...
      >
        ...
        <span className="text-[10px] text-muted-foreground select-none">间距</span>
      </div>
      <div
        className="flex items-center gap-1.5 cursor-pointer"
      ...
      >
        ...
        <span className="text-[10px] text-muted-foreground select-none">环绕间距</span>
      </div>
    </div>
  );
}
...
function LayoutSectionInner({ node, onUpdate }: LayoutSectionProps) {
  ...
  return (
    <div className="space-y-3">
      <span className="text-[11px] font-medium text-foreground">弹性布局</span>
      ...
      {hasLayout && (
        <>
          <div className="flex gap-2">
            ...
            <div>
              <span className="text-[10px] text-muted-foreground mb-1.5 block">间距</span>
              <GapSection
                gap={gap}
                gapMode={gapMode}
      ...
      {(width !== undefined || height !== undefined) && (
        <div>
          <span className="text-[10px] text-muted-foreground mb-1.5 block">尺寸</span>
